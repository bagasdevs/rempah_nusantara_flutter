...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFF2E7D32); // Green from design
  ...
  static ThemeData lightTheme() {
    return ThemeData(
      ...
      chipTheme: const ChipThemeData(
        backgroundColor: Color(0x1A66BB6A),
...
// Text Styles untuk reusable components
class AppTextStyles {
...
class AppSizes {
  ...
  // Spacing (aliases for padding for better semantics)
  static const double spacingSmall = paddingSM;
  static const double spacingMedium = paddingMD;
  static const double spacingLarge = paddingLG;
